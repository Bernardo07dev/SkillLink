...
const Landing = () => {
  ...
  return (
    <main className="bg-[#000102] text-white">
        <section className="relative w-full lg:min-h-screen flex flex-col">
            <div className="absolute inset-0 z-0 lg:min-h-screen">
                <img src="/Bg-centro.png" className="absolute object-cover inset-0 w-full lg:h-screen opacity-70" />
                <div className="absolute z-1 inset-0 bg-linear-to-b from-[#0000009b] to-[#000000]"></div>
            </div>

        <MenuLanding></MenuLanding>

        <section className="z-10 relative text-center py-[15%] flex flex-col justify-center items-center">
            <img src={Logo} className="lg:w-[9%] w-[20%] mt-6"></img>
            <h1 className="lg:text-5xl text-3xl mt-4 w-[60%] tracking-tighter">Conecte talentos. Requalifique pessoas. <strong>Transforme o trabalho.</strong></h1>
            <p className="lg:w-[40%] w-[80%] mt-6 text-gray-300">O SkillLink é uma plataforma inteligente que forma equipes de alta performance com base em habilidades reais.</p>
        ...
        <section className="lg:px-[14%] px-6 py-22 bg-[#000102] flex flex-col justify-center items-center" id="funciona">
            <h3 className="text-[#38BDF8] text-center font-bold mb-2">Como Funciona</h3>
            <h1 className="text-center tracking-light font-bold text-2xl lg:text-4xl leading-tigh lg:mx-32">Um processo simplificado para construir equipes de alto impacto</h1>
            <p className=" mt-6 text-gray-300 text-center text-base lg:mx-22 mb-8">Nossa plataforma intuitiva guia você desde o mapeamento de competências até a formação de equipes otimizadas, identificando oportunidades de crescimento ao longo do caminho.</p>
        ...
        <section className="lg:px-[14%] px-6 gap-8 py-22 bg-[#000102] flex flex-col lg:flex-row justify-center items-center" id="empresas">
            <div className="lg:w-[50%] flex flex-col">
                <h3 className="text-[#38BDF8] font-bold mb-2 text-left">Para empresas e times</h3>
                <h1 className="tracking-light font-bold text-2xl lg:text-4xl mb-2 leading-tigh text-left">Um processo simplificado para construir equipes de alto impacto</h1>
        ...
        <section className="py-16 bg-[#000102] flex flex-col justify-center items-center pb-32" id="pronto">
            <div class="border border-[#182534] lg:w-[70%] w-[90%] flex flex-col justify-center items-center py-16 p-8 lg:p-16 relative rounded-xl overflow-hidden bg-linear-to-r from-[#090712] via-[#041E23] to-[#090712]">               
                    <h2 class="text-white text-2xl text-center lg:text-3xl font-bold mb-2">Pronto para construir sua equipe de alta performance?</h2>
                    <p class="text-gray-300 text-base text-center lg:mx-42">
        ...
        <footer className="bg-[#000102] flex flex-col lg:flex-row justify-between px-[15%] border-t border-gray-800 py-12 items-center">
            <div className="flex flex-row w-[50%] justify-start items-center">
                <img className="lg:w-[20%] w-[70%] mb-6" src={Logo}></img>
            </div>
            <div className="text-sm flex flex-row lg:w-[50%] list-none justify-end gap-4">
