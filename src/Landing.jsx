    ...
    return (
        <main className="bg-[#000102] text-white">
            ...
            <section className="z-10 relative text-center py-[12%] flex flex-col justify-center items-center">
                ...
                <button className="mt-4 px-8 py-4 rounded-xl backdrop-blur-lg cursor-pointer bg-[#38BDF8] text-black font-semibold" onClick={() => navigate("/Login")}>Mude sua equipe conosco</button>
            </section>
