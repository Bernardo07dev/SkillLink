                            ...
                            <div key={i} className='dark:bg-[#182832] bg-white p-6 rounded-lg lg:w-[35%] flex flex-col justify-around mx-2 my-6'>
                                ...
                                <div className='flex flex-row'>
                                    ...
                                    <div
                                        className={`${
                                            item.status === 'Ativo'
                                                ? 'dark:bg-[#1A473B] bg-[#c8ead9] text-[#15d65c] dark:text-[#48D97E]'
                                                : item.status === 'Em formação'
                                                ? 'dark:bg-[#42442A] bg-[#eff0afc7] text-[#E8BF17]'
                                                : item.status === 'Concluído'
                                                ? 'dark:bg-[#1F3A59] bg-[#bccaefc7] text-[#5898E7]'
                                ...
                                <div className='flex flex-row gap-2 mb-4'>
                                    {item.habilidades.map((hard, idx) => (
                                        <div key={idx} className='p-2 text-center rounded-lg text-xs text-gray-400 font-semibold bg-gray-100 dark:bg-[#283339]'>
                                            {hard}
                                        </div>
                                    ))}
                                </div>
                                ...
                                <button className='mt-4 font-semibold text-white dark:text-black text-sm bg-[#13A4EC] py-2 rounded-md'>
                                    Ver Detalhes
                                </button>
