    ...
    return(
        <Structure estado="projetos">
            <main className="p-8">
                ...
                <div className='mt-4'>
                    {/* Select Status */}
                    <select className="dark:bg-[#101C22] bg-white mr-4 px-4 text-gray-400 font-medium text-sm p-3 rounded-full border-none" onChange={(e) => setStatus(e.target.value)} value={getstatus}>
                    ...
                    <select className="dark:bg-[#101C22] bg-white px-6 text-gray-400 font-medium text-sm p-3 rounded-full border-none" onChange={(e) => setArea(e.target.value)} value={getarea}>
                    ...
                    <div className='flex flex-row'>
                        {filtrados && filtrados.length > 0 ? filtrados.map((valor, i) => (
                            <div className='dark:bg-[#182832] bg-white p-6 rounded-lg w-[25%] flex flex-col justify-around mx-2 my-6'>
                                <div className='flex flex-row'>
